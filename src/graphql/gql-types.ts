...
export interface IMutation {
    ...
    createPerson(createPersonInput: CreatePersonInput): Person | Promise<Person>;
    updatePerson(id: number, updatePersonInput: UpdatePersonInput): Person | Promise<Person>;
    deletePerson(id: number): Person | Promise<Person>;
...
export interface IQuery {
    ...
    persons(): Nullable<Nullable<Person>[]> | Promise<Nullable<Nullable<Person>[]>>;
